        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              Ready to transform your website's performance? Let's discuss how AICO can help your business grow.
            </p>
          </div>
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-1 space-y-6">
              <Card>
                ...
                <CardContent>
                  <p className="font-medium">hello@aico.com</p>
              ...
              <Card>
                ...
                <CardContent>
                  <p className="font-medium">123 AI Street</p>
